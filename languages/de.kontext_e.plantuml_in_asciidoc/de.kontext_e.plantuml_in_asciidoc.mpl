...
<language namespace="de.kontext_e.plantuml_in_asciidoc" uuid="542b09d5-9fea-43d0-b4e4-812d7527e00f" version="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator generatorUID="de.kontext_e.plantuml_in_asciidoc#3181446686395638402" uuid="63272394-1231-4fe5-bc72-a6777621483a">
      <models>
        <modelRoot contentPath="${module}" type="default">
